...
function useArrayState(initialState = null) {
  ...
  /**
   * Removes the item at the specified `index`. The item is erased from the array, not set to undefined or empty.
   * The `index+1` item will take the `index` position, and so on. This will provoke a re-render.
