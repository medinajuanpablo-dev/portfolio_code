 ...
 * @param {Object} props
 * @param {"light" | "medium" | "strong" | "very-strong" | "dark" } props.overlay The overlay strength over the background. Leave `undefined` to disable.
...
const DIRECTED_STYLES = {
  ...
  overlay: "w-full h-full || ol<bg-black'bg-opacity-25> om<bg-black'bg-opacity-40> os<bg-black'bg-opacity-60> ov<bg-black'bg-opacity-80> od<bg-black'bg-opacity-90>",
};
...
const INDICATORS = [
  ...
  {key: "dark", directive: "od", condition: p => p.overlay == "dark"},
]
