...
const displayCuteMessage = usgMessagesList({ maxItems: 3, alignment: "left" });

function CuteMessagesListExample() {
  var helped = false; //To avoid clicking the "Help me" twice to the same message.
  ...
  function onColdClick() {
    displayCuteMessage({
      ...
      lifeTime: 0,
      straightStyles: { icon: "text-blue-600" },
      button: {
        text: "Help me!",
        onClick: (closeFather) => {
          if (!helped)
